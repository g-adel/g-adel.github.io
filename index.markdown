  ...
  <div class="sidebar" style="flex: 1; max-width: 100%;">
      <div style="transform: scale(0.9); transform-origin: top right;">
        ...
        <bsky-embed
          ...
          limit="5"
          load-more="true"
          custom-styles="img { display: none !important; } a.border .p-3 .whitespace-pre-wrap { display: none !important; } p.whitespace-pre-wrap { display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; }"
        >
        </bsky-embed>
      </div>
    </div>
